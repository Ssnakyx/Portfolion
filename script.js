...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectsData = [
        {
            title: "Forum Project",
            description: "A collaborative forum for mountain enthusiasts with features like photo sharing, interactive maps, and user reviews.",
            image: "https://via.placeholder.com/600x400?text=Mountain+Forum+Project",
        ...
        {
            title: "Hackathon B2",
            description: "A project developed during a hackathon event, showcasing rapid development and innovative problem-solving skills.",
            image: "https://via.placeholder.com/600x400?text=Hackathon+B2+Project",
        ...
        {
            title: "HangMan 2023",
            description: "A modern implementation of the classic Hangman word guessing game with enhanced graphics and gameplay features.",
            image: "https://via.placeholder.com/600x400?text=HangMan+2023+Game",
            githubUrl: "https://github.com/Ssnakyx/HangMan-2023",
            technologies: ["Java", "JavaFX", "Game Development", "UI Design"]
        },
        {
            title: "HangMan Web",
            description: "A web-based version of the Hangman game with a responsive user interface, allowing players to guess words through a browser.",
            image: "https://via.placeholder.com/600x400?text=HangMan+Web+Game",
            githubUrl: "https://github.com/Ssnakyx/HangMan_Web",
            technologies: ["HTML", "CSS", "JavaScript", "Web Development"]
        },
        {
            title: "Minecraft Server",
            description: "A custom Minecraft server implementation with configuration tools and plugins for enhanced gameplay experiences.",
            image: "https://via.placeholder.com/600x400?text=Minecraft+Server+Project",
            githubUrl: "https://github.com/Ssnakyx/MinecraftServer",
            technologies: ["Java", "Server Management", "Game Modding", "Networking"]
        },
        {
            title: "BreakOut Game",
            description: "A recreation of the classic Breakout arcade game with modern graphics and additional gameplay features.",
            image: "https://via.placeholder.com/600x400?text=BreakOut+Game",
            githubUrl: "https://github.com/Ssnakyx/BreakOut_Game",
            technologies: ["Java", "Game Development", "Graphics", "Game Design"]
        },
        {
            title: "PokeHamed",
            description: "A Pokémon-themed application featuring a custom Pokédex, battle simulator, and collection management system.",
            image: "https://via.placeholder.com/600x400?text=PokeHamed+App",
            githubUrl: "https://github.com/Ssnakyx/PokeHamed",
            technologies: ["Java", "API Integration", "Database", "Game Development"]
        },
        {
            title: "Portfolio Website",
            description: "This portfolio website built with HTML, CSS, and JavaScript for a responsive and interactive experience.",
