export const services = [
  {
    ...
    tags: ["HTML, CSS, JavaScript", "Java, Go, Node.js", "Git, GitHub, API REST"],
  },
  {
    number: "02",
    ...
    tags: ["Vue.js, React", "Design responsive", "Figma → Code pixel-perfect"],
  },
  {
    number: "03",
    title: "Jeux & Systèmes",
    ...
    tags: ["Java, JavaFX", "Plugins Minecraft", "Architecture serveur"],
  },
]
...
export const projects = [
  {
    ...
    year: "2023",
    description: "Un forum collaboratif pour les passionnés de montagne avec partage de photos, cartes interactives et avis d'utilisateurs.",
    technologies: ["HTML", "CSS", "Go", "Collaboration"],
    githubUrl: "https://github.com/B1-Info-23-24/projet-forum-erwan-lucas-hamed-tom",
    details: {
      longDescription: "Ce projet consiste en un forum collaboratif conçu pour les passionnés de montagne. Il propose le partage de photos, des cartes interactives et des avis d'utilisateurs.",
      date: "Octobre 2023 - Décembre 2023",
      role: "Développeur full-stack",
      challenges: "Intégration des cartes interactives et gestion des uploads de photos.",
      solutions: "Utilisation de Go pour le backend et mise en place d'un système de cache.",
      status: "Terminé",
    },
  },
  {
    ...
    category: "DÉVELOPPEMENT",
    year: "2023",
    description: "Projet développé lors d'un hackathon de 48h, démontrant un développement rapide et innovant en équipe.",
    technologies: ["Innovation", "Agile", "Équipe"],
    githubUrl: "https://github.com/Tokennn/Hackaton-B2",
    details: {
      longDescription: "Projet développé dans le cadre d'un hackathon de 48 heures pour améliorer la vie étudiante sur le campus.",
      date: "Mars 2023",
  ...
  },
  {
    ...
    category: "DÉVELOPPEMENT",
    year: "2023",
    description: "Version web du jeu du Pendu avec interface responsive, accessible depuis n'importe quel navigateur.",
    technologies: ["HTML", "CSS", "JavaScript"],
    githubUrl: "https://github.com/Ssnakyx/HangMan_Web",
    details: {
      longDescription: "Version web du jeu du Pendu accessible à tous via un navigateur, avec stockage local des scores.",
  ...
  },
  {
    ...
    category: "DÉVELOPPEMENT",
    year: "2022",
    description: "Application Pokémon complète avec Pokédex, simulateur de combat et système de gestion de collection.",
    technologies: ["Java", "API", "Base de données"],
    githubUrl: "https://github.com/Ssnakyx/PokeHamed",
    details: {
      longDescription: "Application complète sur le thème de Pokémon avec Pokédex, simulateur de combat et gestion de collection.",
  ...
  },
  {
    ...
    category: "SYSTÈMES",
    year: "2022",
    description: "Serveur Minecraft personnalisé avec plugins custom et outils de configuration avancés.",
    technologies: ["Java", "Réseaux", "Plugins"],
    githubUrl: "https://github.com/Ssnakyx/MinecraftServer",
    details: {
      longDescription: "Suite d'outils et de plugins personnalisés pour améliorer l'expérience de jeu sur serveurs Minecraft.",
