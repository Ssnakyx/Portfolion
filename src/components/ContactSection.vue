<template>
  <section id="contact" class="section cta-section" role="region" aria-labelledby="contact-title">
    <div class="container">
      <div class="divider" style="margin-bottom: 4rem"></div>
      <div class="cta-content">
        <div class="fade-up">
          <h2 id="contact-title" class="cta-heading">
            LET'S<br />
            <span class="accent">MAKE IT</span><br />
            HAPPEN
          </h2>
          <div class="contact-links">
            <a href="mailto:hamed0405n@gmail.com" class="contact-link">
              ...
              hamed0405n@gmail.com
            </a>
            <a href="https://github.com/Ssnakyx" target="_blank" rel="noopener noreferrer" class="contact-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
              github.com/Ssnakyx
            </a>
            <a href="https://www.linkedin.com/in/hamed-kaffa-98587032a/" target="_blank" rel="noopener noreferrer" class="contact-link">
        ...
        <div class="fade-up">
          <form class="contact-form" action="https://formsubmit.co/hamed0405n@gmail.com" method="POST">
            <input type="hidden" name="_subject" value="Nouveau message depuis votre portfolio" />
            <input type="hidden" name="_captcha" value="false" />
            <input type="hidden" name="_next" value="https://portfoliohamed.netlify.app/merci.html" />
